      ...
      <Content data-sal="fade" data-sal-delay="300" data-sal-easing="ease">
        <div style={{display: "flex", flexDirection: "column"}}>
          ...
          <ParagraphText padding={"0 0 2rem 0"}>
            ...
            Czech Republic. I've been working for more than 10 years in international organisations such as the European Commission, managing their online & visual communication as Digital Leader. In the past three years, I took up web development and created a number of web & mobile applications for work and for fun. When it comes to front-end, my tool of choice is ReactJS (with functional components & hooks), and React Native on mobile (with Expo). I also love the development experience offered by GatsbyJS. On
